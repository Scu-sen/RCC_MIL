...
**In order to train RCC_MIL, you need to prepare two folders, one with no overlap between patches and the other with an overlap of 0.5**
...
We have prepared two config file templates (see ./configs/) for RCC_MIL and other baselines, like
