...
class Trainer:
    ...
    def get_model(self):
        ...
        if self.cfg.Model.network == 'RCC_MIL':
            from models.RCC_MIL import RCC_MIL
            model = RCC_MIL(features_size=self.cfg.Data.features_size, n_classes=self.cfg.Data.n_classes)
        else:
            raise NotImplementedError
    ...
    def get_train_loop(self):
        cfg = self.cfg
        if cfg.Train.train_method == 'RCC_MIL':
            from training_methods.RCC_MIL import train_loop
        else:
            raise NotImplementedError
    ...
    def get_validation(self):
        cfg = self.cfg
        if cfg.Train.val_method == 'RCC_MIL':
            from training_methods.RCC_MIL import validation
        else:
            raise NotImplementedError
    ...
    def get_summary(self):
        cfg = self.cfg
        if cfg.Train.val_method == 'RCC_MIL':
            from training_methods.RCC_MIL import summary
        else:
            raise NotImplementedError
